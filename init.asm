...
main(void)
{
  ...
  82:	68 ab 07 00 00       	push   $0x7ab
  87:	e8 be 02 00 00       	call   34a <exec>
      printf(1, "init: exec sh failed\n");
  8c:	5a                   	pop    %edx
  8d:	59                   	pop    %ecx
  8e:	68 ae 07 00 00       	push   $0x7ae
  93:	6a 01                	push   $0x1
...
main(void)
{
  ...
  a0:	6a 01                	push   $0x1
  a2:	6a 01                	push   $0x1
  a4:	68 90 07 00 00       	push   $0x790
  a9:	e8 ac 02 00 00       	call   35a <mknod>
    open("console", O_RDWR);
  ae:	58                   	pop    %eax
  af:	5a                   	pop    %edx
  b0:	6a 02                	push   $0x2
  b2:	68 90 07 00 00       	push   $0x790
...
putc(int fd, char c)
{
 ...
 448:	e8 e5 fe ff ff       	call   332 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 588:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 58b:	b8 c4 07 00 00       	mov    $0x7c4,%eax
...
free(void *ap)
{
 ...
 667:	89 08                	mov    %ecx,(%eax)
  freep = p;
 669:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 66e:	5b                   	pop    %ebx
 66f:	5e                   	pop    %esi
 670:	5f                   	pop    %edi
 ...
 68a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 68d:	a3 70 0a 00 00       	mov    %eax,0xa70
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 74c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 74f:	89 15 70 0a 00 00    	mov    %edx,0xa70
      return (void*)(p + 1);
 ...
 764:	eb e9                	jmp    74f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 766:	c7 05 70 0a 00 00 74 	movl   $0xa74,0xa70
 76d:	0a 00 00 
 770:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 777:	0a 00 00 
    base.s.size = 0;
 77a:	b8 74 0a 00 00       	mov    $0xa74,%eax
 77f:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 786:	00 00 00 
